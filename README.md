--[[
    ...
    ║                 🐉 DRAGON HUB – V5                         ║
    ║                 By: Norton                                  ║
    ║     Update 30 – Setembro 2026 – Blox Fruits                ║
    ║                                                             ║
    ║     🔑 Sistema de key ativado                              ║
    ║     Chave padrão: DRAGON2026                              ║
    ║     Tema: Laranja 🔶 e Preto ⬛                            ║
    ║     Efeito: Acrílico ✨                                    ║
    ║     TODAS AS FUNÇÕES DO CAVEIRA HUB MANTIDAS              ║
    ╚══════════════════════════════════════════════════════════════╝
--]]
...
local KeySystem = Fluent:CreateKeySystem({
    ...
    FileName = "DragonHubKey",
    SaveKey = true,
    Key = "DRAGON2026"
})

KeySystem:OnKeyValidation(function()
    local Window = Fluent:CreateWindow({
        Title = "🐉 Dragon Hub",
        SubTitle = "By: Norton | Update 30",
        TabWidth = 180,
    ...
    -- ScreenGui (Botão flutuante laranja)
    ...
    ToggleButton.Image = "rbxassetid://130364232574601"
    ...
    -- TABS (MODIFICADO: Valentine removido, Magnetic adicionado)
    local Tabs = {
        ...
        Magnetic = Window:AddTab({Title = "🧲Magnetic Event", Icon = ""}), -- SUBSTITUÍDO
    ...
    -- ============================================================
    -- TODOS OS BOTÕES ORIGINAIS DO CAVEIRA HUB (MANTIDOS)
    -- ============================================================
    -- [Farm Level]
    local FarmLevel = Tabs.Main:AddToggle("FarmLevel", {Title = "Auto Farm Level", Description = "", Default = false})
    FarmLevel:OnChanged(function(Value) _G.Level = Value end)
    spawn(function()
        while wait(Sec) do
            if _G.Level then
                pcall(function()
    ...
    TravelDress:OnChanged(function(Value) _G.TravelDres = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    Zou:OnChanged(function(Value) _G.AutoZou = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
                if _G.AutoZou then
    ...
    ClosetMons:OnChanged(function(Value) _G.AutoFarmNear = Value end)
    spawn(function()
        while wait() do
            pcall(function()
    ...
    FactoryRaids:OnChanged(function(Value) _G.AutoFactory = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    CastleRaids:OnChanged(function(Value) _G.AutoRaidCastle = Value end)
    spawn(function()
        while wait(Sec) do
    ...
    Test:OnChanged(function(Value) getgenv().SelectMaterial = Value end)
    Toggle = Tabs.Main:AddToggle("Toggle", {Title = "Auto Materials", Description = "", Default = false})
    Toggle:OnChanged(function(Value) getgenv().AutoMaterial = Value end)
    spawn(function()
    ...
    Q:OnChanged(function(Value) _G.AutoEctoplasm = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    Bartilo:OnChanged(function(Value) _G.Bartilo_Quest = Value end)
    spawn(function()
        while wait(.1) do    
            pcall(function()
    ...
    CitizenQ:OnChanged(function(Value) _G.CitizenQuest = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    Q:OnChanged(function(Value) _G.DummyMan = Value end)
    spawn(function()
        while wait(Sec) do
            if _G.DummyMan then
                pcall(function()
    ...
    Berry:OnChanged(function(Value) _G.AutoBerry = Value end)
    spawn(function()
        while wait(Sec) do
    ...
    Chest:OnChanged(function(Value) _G.AutoFarmChest = Value end)
    spawn(function()
        while wait(Sec) do
    ...
    Mastery_Config:OnChanged(function(Value) SelectIsland = Value end)

    -- [Auto Mastery Fruits]
    local MasteryFruits = Tabs.Main:AddToggle("MasteryFruits", {Title = "Auto Mastery Fruits", Description = "", Default = false})
    MasteryFruits:OnChanged(function(Value) _G.FarmMastery_Dev = Value end)
    ...
    MasteryGun:OnChanged(function(Value) _G.FarmMastery_G = Value end)
    spawn(function()
        while wait(Sec) do
    ...
    spawn(function()
        while wait(.2) do
            pcall(function()
                ...
                if Killed then MobKilled:SetDesc(" Killed : " ..(500 - Killed)) end
            end)
        end
    end)
    ...
    Q:OnChanged(function(Value) _G.Auto_Cake_Prince = Value end)
    spawn(function()
        while wait() do
    ...
    Q:OnChanged(function(Value) _G.AutoFarm_Bone = Value end)
    spawn(function()
        while wait(Sec) do 
    ...
    Q:OnChanged(function(Value) _G.AcceptQuestC = Value end)          

    -- [Auto Farm Mirror]
    local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Farm Mirror", Description = "", Default = false})
    Q:OnChanged(function(Value) _G.AutoMiror = Value end)
    spawn(function()
        while wait(Sec) do
    ...
    Q:OnChanged(function(Value) _G.AutoHytHallow = Value end)
    spawn(function()
        while wait(Sec) do
    ...
    Q:OnChanged(function(Value) _G.Auto_Random_Bone = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    Tabs.Main:AddButton({Title = "Buy Buso Colors", Description = "", Callback = function() replicated.Remotes.CommF_:InvokeServer("ColorsDealer","2") end })

    -- [Auto Rainbow Colors]
    local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Rainbow Colors", Description = "", Default = false})
    Q:OnChanged(function(Value) _G.Auto_Rainbow_Haki = Value end)
    spawn(function()
        pcall(function()
            while wait(Sec) do
    ...
    Q:OnChanged(function(Value) _G.obsFarm = Value end)
    spawn(function()
        while wait(.2) do
            pcall(function()
                if _G.obsFarm then        
                    replicated.Remotes.CommE:FireServer("Ken",true)
                    if plr:GetAttribute("KenDodgesLeft") == 0 then KenTest = false
                    elseif plr:GetAttribute("KenDodgesLeft") > 0 then replicated.Remotes.CommE:FireServer("Ken",true) KenTest = true end        
                end
            end)
        end
    end)    
    ...
    Q:OnChanged(function(Value) _G.AutoKenVTWO = Value end)
    spawn(function()
        while wait(Sec) do
    ...
    -- [Auto Upgrade Mink V3]
    local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Upgrade Mink V3", Description = "", Default = false})
    Q:OnChanged(function(Value) _G.Auto_Mink = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
                if _G.Auto_Mink then
                    if replicated.Remotes.CommF_:InvokeServer("Alchemist","1") ~= 2 then
                        if replicated.Remotes.CommF_:InvokeServer("Alchemist","1") == 0 then replicated.Remotes.CommF_:InvokeServer("Alchemist","2")
                        elseif replicated.Remotes.CommF_:InvokeServer("Alchemist","1") == 1 then
                            if not plr.Backpack:FindFirstChild("Flower 1") and not plr.Character:FindFirstChild("Flower 1") then _tp(workspace.Flower1.CFrame)
                            elseif not plr.Backpack:FindFirstChild("Flower 2") and not plr.Character:FindFirstChild("Flower 2") then _tp(workspace.Flower2.CFrame)
                        ...
                        elseif replicated.Remotes.CommF_:InvokeServer("Alchemist","1") == 2 then replicated.Remotes.CommF_:InvokeServer("Alchemist","3") end
                    elseif replicated.Remotes.CommF_:InvokeServer("Wenlocktoad","1") == 0 then replicated.Remotes.CommF_:InvokeServer("Wenlocktoad","2")
                    elseif replicated.Remotes.CommF_:InvokeServer("Wenlocktoad","1") == 1 then _G.AutoFarmChest = true
                    else _G.AutoFarmChest = false end
                end
            end)
        end
    end)

    -- [Auto Upgrade Human V3]
    local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Upgrade Human V3", Description = "", Default = false})
    Q:OnChanged(function(Value) _G.Auto_Human = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
                if _G.Auto_Human then
                    ...
                    elseif replicated.Remotes.CommF_:InvokeServer("Wenlocktoad","1") == 1 then
                        ...
                        else _tp(CFrame.new(-2172.7399902344, 103.32216644287, -4015.025390625)) end
                ...
                if _G.Auto_Skypiea then
                    if replicated.Remotes.CommF_:InvokeServer("Alchemist","1") ~= -2 then
                        ...
                        elseif replicated.Remotes.CommF_:InvokeServer("Alchemist","1") == 1 then
                            ...
                            elseif not plr.Backpack:FindFirstChild("Flower 3") and not plr.Character:FindFirstChild("Flower 3") then
                                local v = GetConnectionEnemies("Swan Pirate")
                                if v then repeat wait()Attack.Kill(v,_G.Auto_Skypiea) until plr.Backpack:FindFirstChild("Flower 3") or not v.Parent or v.Humanoid.Health <= 0 or _G.Auto_Skypiea == false
                                else _tp(CFrame.new(980.0985107421875, 121.331298828125, 1287.2093505859375)) end
                            end
                        elseif replicated.Remotes.CommF_:InvokeServer("Alchemist","1") == 2 then replicated.Remotes.CommF_:InvokeServer("Alchemist","3") end
                    elseif replicated.Remotes.CommF_:InvokeServer("Wenlocktoad","1") == 0 then replicated.Remotes.CommF_:InvokeServer("Wenlocktoad","2")
                ...
                if _G.Auto_Fish then
                    if replicated.Remotes.CommF_:InvokeServer("Alchemist","1") ~= -2 then
                        ...
                        elseif replicated.Remotes.CommF_:InvokeServer("Alchemist","1") == 1 then
                            ...
                            elseif not plr.Backpack:FindFirstChild("Flower 3") and not plr.Character:FindFirstChild("Flower 3") then
                                local v = GetConnectionEnemies("Swan Pirate")
                                if v then repeat wait()Attack.Kill(v,_G.Auto_Fish) until plr.Backpack:FindFirstChild("Flower 3") or not v.Parent or v.Humanoid.Health <= 0 or _G.Auto_Fish == false
                                else _tp(CFrame.new(980.0985107421875, 121.331298828125, 1287.2093505859375)) end
                            end
                        elseif replicated.Remotes.CommF_:InvokeServer("Alchemist","1") == 2 then replicated.Remotes.CommF_:InvokeServer("Alchemist","3") end
                    elseif replicated.Remotes.CommF_:InvokeServer("Wenlocktoad","1") == 0 then replicated.Remotes.CommF_:InvokeServer("Wenlocktoad","2")
                    elseif replicated.Remotes.CommF_:InvokeServer("Wenlocktoad","1") == 1 then warn("Sea Beast Soon") end
                end
            end)
        end
    end)
    ...
    Q:OnChanged(function(Value) _G.AutoRipIngay = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    Weapon_Config:OnChanged(function(Value) _G.ChooseWP = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
                if _G.ChooseWP == "Melee" then
                    for _,v in pairs(plr.Backpack:GetChildren()) do
                        if v.ToolTip == "Melee" then
                            if plr.Backpack:FindFirstChild(tostring(v.Name)) then _G.SelectWeapon = v.Name end
                        end
                    end
    ...
    RaceV3Aura:OnChanged(function(Value) _G.RaceClickAutov3 = Value end)
    spawn(function()
        while wait(.2) do
            pcall(function()
    ...
    RaceV4Aura:OnChanged(function(Value) _G.RaceClickAutov4 = Value end)
    spawn(function()
        while wait(.2) do
            pcall(function()
    ...
    RandomAround:OnChanged(function(Value) RandomCFrame = Value end)

    local Byp = Tabs.Settings:AddToggle("Byp", {Title = "Turn on Bypass Teleport", Description = "", Default = false})
    Byp:OnChanged(function(Value) _G.Bypass = Value end)
    ...
    SafeModes:OnChanged(function(Value) _G.Safemode = Value end)
    spawn(function()
    ...
    UnDetectedAFK:OnChanged(function(Value) _G.AntiAFK = Value end)
    ...
    DisblesVFX:OnChanged(function(Value) _G.DistroyHit = Value end)
    spawn(function()
        while wait(Sec) do
    ...
    DisblesVFX:OnChanged(function(Value) RDeath = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
                if RDeath then
    ...
    DisblesVFX:OnChanged(function(Value) RemoveDamage = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    local StatusSelect = Tabs.Settings:AddSlider("StatusSelect",{Title = "Stats Value",Description = "choose your point need to upgrade",Default = 10,Min = 0,Max = 1000,Rounding = 1, Callback = function(Value) pSats = Value end})
    StatusSelect:OnChanged(function(Value) pSats = Value end)

    local StatsUpg = Tabs.Settings:AddToggle("StatsUpg", {Title = "Auto Melee", Description = "", Default = false})
    StatsUpg:OnChanged(function(Value) _G.Auto_Melee = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    StatsUpg:OnChanged(function(Value) _G.Auto_Sword = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    StatsUpg:OnChanged(function(Value) _G.Auto_Gun = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    StatsUpg:OnChanged(function(Value) _G.Auto_DevilFruit = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    StatsUpg:OnChanged(function(Value) _G.Auto_Defense = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    -- ============================================================
    -- MELEE TAB (Fighting Styles) – Mantido intacto
    -- ============================================================
    ...
    SuperHuman:OnChanged(function(Value) _G.Auto_SuperHuman = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    DeathStep:OnChanged(function(Value) _G.AutoDeathStep = Value end)
    spawn(function()
        while wait(Sec) do
    ...
    SharkManV2:OnChanged(function(Value) _G.Auto_SharkMan_Karate = Value end)
    spawn(function() 
        while wait(Sec) do
    ...
    ElectricClaw:OnChanged(function(Value) _G.Auto_Electric_Claw = Value end)
    spawn(function()
        while wait(Sec) do
    ...
    DragonTalon:OnChanged(function(Value) _G.AutoDragonTalon = Value end)
    spawn(function()
        while wait(Sec) do
    ...
    Godhuman:OnChanged(function(Value) _G.Auto_God_Human = Value end)
    spawn(function()
        while wait() do
            pcall(function()
                if _G.AutoGodHuman then
                    ...
                    elseif replicated.Remotes.CommF_:InvokeServer("BuyGodhuman",true) == 3 then return nil
                    else replicated.Remotes.CommF_:InvokeServer("BuyGodhuman") end
                end
            end)
        end
    end)
    ...
    SanguineArt:OnChanged(function(Value) _G.snaguine = Value end)
    spawn(function()
        while wait(Sec) do
            if _G.snaguine then
                pcall(function()
                    ...
                    else replicated.Remotes.CommF_:InvokeServer("BuySanguineArt") end
                end)
            end
        end
    end)
    ...
    -- ============================================================
    -- QUESTS TAB (Tushita + Yama, CDK, etc.) – Mantido intacto
    -- ============================================================
    ...
    Q:OnChanged(function(Value) _G.FarmEliteHunt = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
                if _G.FarmEliteHunt then
                    if plr.PlayerGui.Main.Quest.Visible == true then
                        if string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Diablo") or string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Urban") or string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Deandre") then
                            for i,v in pairs(replicated:GetChildren()) do
                                if string.find(v.Name,"Diablo") or string.find(v.Name,"Urban") or string.find(v.Name,"Deandre") then _tp(v.HumanoidRootPart.CFrame) end
                            end
    ...
    -- [Stop when got God's Chalice]
    local Q = Tabs.Quests:AddToggle("Q", {Title = "Stop when got God's Chalice", Description = "", Default = true})
    Q:OnChanged(function(Value) _G.StopWhenChalice = Value end)
    spawn(function()
        while wait(.2) do
            if _G.StopWhenChalice and _G.FarmEliteHunt then
                pcall(function()
                    if GetBP("God's Chalice") or GetBP("Sweet Chalice") or GetBP("Fist of Darkness") then _G.FarmEliteHunt = false end
                end)
            end
        end
    end)
    ...
    Q:OnChanged(function(Value) _G.Auto_Tushita = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    Q:OnChanged(function(Value) _G.Auto_Yama = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
                if _G.Auto_Yama then
                    if replicated.Remotes.CommF_:InvokeServer("EliteHunter", "Progress") < 30 then _G.FarmEliteHunt = true
    ...
    spawn(function()  
        while wait(.2) do 
            if QuestYama_1 == true then CheckCDK:SetDesc(" Quest Numbers : yama quest 1") 
            elseif QuestYama_2 == true then CheckCDK:SetDesc(" Quest Numbers : yama quest 2") 
            elseif QuestYama_3 == true then CheckCDK:SetDesc(" Quest Numbers : yama quest 3") 
            elseif QuestTushita_1 == true then CheckCDK:SetDesc(" Quest Numbers : tushita quest 1") 
            elseif QuestTushita_2 == true then CheckCDK:SetDesc(" Quest Numbers : tushita quest 2") 
            elseif QuestTushita_1 == true then CheckCDK:SetDesc(" Quest Numbers: tushita quest 2") 
            elseif GetWP("Cursed Dual Katana") then CheckCDK:SetDesc(" Quest Numbers: CDK done!!") end 
        end
    end) 

    -- [Auto Get CDK Last Quest]
    local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Get CDK [ Last Quest ]", Description = "", Default = false})
    Q:OnChanged(function(Value) _G.CDK = Value end)
    spawn(function()    
        while wait(Sec) do
            pcall(function()
                if _G.CDK then
    ...
    Q:OnChanged(function(Value) _G.CDK_YM = Value end)
    spawn(function()
        while wait() do
            pcall(function()
                if _G.CDK_YM then
                    if tostring(replicated.Remotes.CommF_:InvokeServer("CDKQuest", "OpenDoor")) ~= "opened" then                  
                        ...
                        elseif replicated.Remotes.CommF_:InvokeServer("CDKQuest","Progress")["Finished"] == false then                        
                            if tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest","Progress")["Evil"]) == -3 then
                                ...
                                repeat task.wait()
                                    if not workspace.Enemies:FindFirstChild("Forest Pirate") then _tp(CFrame.new(-13223.521484375, 428.1938171386719, -7766.06787109375))
                                    else local v = GetConnectionEnemies("Forest Pirate")
                        ...
                        if not workspace.Map:FindFirstChild("HellDimension") or (Root.Position - workspace.Map.HellDimension.Spawn.Position).Magnitude > 1000 then
                            ...
                            elseif replicated:FindFirstChild("Soul Reaper") and replicated:FindFirstChild("Soul Reaper").Humanoid.Health > 0 then
                                ...
                                if replicated.Remotes.CommF_:InvokeServer("Bones","Check") < 50 and not workspace.Enemies:FindFirstChild("Soul Reaper") and not replicated:FindFirstChild("Soul Reaper") and not workspace.Map:FindFirstChild("HellDimension") then
                                    ...
                                    else _tp(CFrame.new(-9515.2255859375, 164.0062255859375, 5785.38330078125)) end
                                else replicated.Remotes.CommF_:InvokeServer("Bones", "Buy", 1, 1) end
                            end
                        end
                    end
                end
    ...
    Q:OnChanged(function(Value) _G.CDK_TS = Value end)
    spawn(function()
        while wait() do
            pcall(function()
                if _G.CDK_TS then
                            ...
                            elseif tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest","Progress")["Good"]) == -5 then
                                ...
                                elseif replicated:FindFirstChild("Cake Queen") and replicated:FindFirstChild("Cake Queen").Humanoid.Health > 0 then
                                    ...
                                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - workspace.Map.HeavenlyDimension.Spawn.Position).Magnitude <= 1000 then
                                        for i,v in pairs(workspace.Map.HeavenlyDimension.Exit:GetChildren()) do Ex = i end
                                        if Ex == 2 then
                                            repeat wait()
    ...
    Tabs.Quests:AddButton({Title = "Buy Legendary Sword", Description = "", Callback = function()
    ...
    Tabs.Quests:AddButton({Title = "Buy True Triple Katana Sword", Description = "", Callback = function()
        replicated.Remotes.CommF_:InvokeServer("MysteriousMan","2")
    end})

    -- [Tween to Legendary Sword Dealer]
    local Q = Tabs.Quests:AddToggle("Q", {Title = "Tween to Legendary Sword Dealer", Description = "", Default = false})
    Q:OnChanged(function(Value) _G.Tp_LgS = Value end)
    spawn(function()
        while wait(Sec) do
            if _G.Tp_LgS then
                pcall(function()
    ...
    Q:OnChanged(function(Value) _G.AutoPole = Value end)
    spawn(function()
        while wait(Sec) do
            if _G.AutoPole then
                pcall(function()
    ...
    Q:OnChanged(function(Value) _G.AutoPoleV2 = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    Q:OnChanged(function(Value) _G.AutoLawKak = Value end)
    spawn(function()
        while wait(Sec) do
    ...
    Tabs.Quests:AddButton({Title = "Buy Microchip Law", Description = "", Callback = function()
        replicated.Remotes.CommF_:InvokeServer("BlackbeardReward","Microchip","2")
    end})
    Tabs.Quests:AddButton({Title = "Start Law Raids", Description = "", Callback = function()
    ...
    Q:OnChanged(function(Value) _G.AutoSaw = Value end)
    spawn(function()
        while wait(.2) do
            pcall(function()
                if _G.AutoSaw then
    ...
    Q:OnChanged(function(Value) _G.AutoSaber = Value end)
    spawn(function()
        while wait(.2) do
            pcall(function()
                    ...
                    if workspace.Map.Jungle.Final.Part.Transparency == 0 then
                        if workspace.Map.Jungle.QuestPlates.Door.Transparency == 0 then
                            if (CFrame.new(-1612.55884, 36.9774132, 148.719543, 0.37091279, 3.0717151e-09, -0.928667724, 3.97099491e-08, 1, 1.91679348e-08, 0.928667724, -4.39869794e-08, 0.37091279).Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 100 then
                                ...
                                wait(0.5) 
                            else _tp(CFrame.new(-1612.55884, 36.9774132, 148.719543, 0.37091279, 3.0717151e-09, -0.928667724, 3.97099491e-08, 1, 1.91679348e-08, 0.928667724, -4.39869794e-08, 0.37091279)) end
                        else
                            if workspace.Map.Desert.Burn.Part.Transparency == 0 then
                                ...
                                else _tp(CFrame.new(-1610.00757, 11.5049858, 164.001587, 0.984807551, -0.167722285, -0.0449818149, 0.17364943, 0.951244235, 0.254912198, 3.42372805e-05, -0.258850515, 0.965917408)) end
                            else
                                if replicated.Remotes.CommF_:InvokeServer("ProQuestProgress","SickMan") ~= 0 then
                                    ...
                                    if replicated.Remotes.CommF_:InvokeServer("ProQuestProgress","RichSon") == nil then replicated.Remotes.CommF_:InvokeServer("ProQuestProgress","RichSon")
                        ...
                        else _tp(CFrame.new(-1401.85046, 29.9773273, 8.81916237, 0.85820812, 8.76083845e-08, 0.513301849, -8.55007443e-08, 1, -2.77243419e-08, -0.513301849, -2.00944328e-08, 0.85820812)) end
                    end
                end
            end)
        end
    ...
    Q:OnChanged(function(Value) _G.AutoColShad = Value end)
    spawn(function()
        while wait(.2) do
            if _G.AutoColShad then
                pcall(function()
                    ...
                    else _tp(CFrame.new(6094.0249023438, 73.770050048828, 3825.7348632813)) end
                end)
            end
        end
    end)
    ...
    Q:OnChanged(function(Value) _G.AutoGetUsoap = Value end)
    spawn(function()
        while task.wait(Sec) do
            pcall(function()
    ...
    Q:OnChanged(function(Value) _G.Greybeard = Value end)
    spawn(function()
        while wait(Sec) do
            if _G.Greybeard then
                pcall(function()
                    if not GetWP("Bisento") then replicated.Remotes.CommF_:InvokeServer("BuyItem","Bisento")
                    elseif GetWP("Bisento") then
                        ...
                        else _tp(CFrame.new(-5023.38330078125, 28.65203285217285, 4332.3818359375)) end
                    end
                end)
            end
        end
    ...
    Q:OnChanged(function(Value) _G.WardenBoss = Value end)
    spawn(function()
        while wait(.1) do
            if _G.WardenBoss then
                pcall(function()
                    ...
                    else _tp(CFrame.new(5206.92578,0.997753382,814.976746,0.342041343,-0.00062915677,0.939684749,0.00191645394,0.999998152,-2.80422337e-05,-0.939682961,0.00181045406,0.342041939)) end
                end)
            end
        end
    end)
    ...
    Q:OnChanged(function(Value) _G.MarinesCoat = Value end)
    spawn(function()
        while wait(.1) do
    ...
    Q:OnChanged(function(Value) _G.SwanCoat = Value end)
    spawn(function()
        while wait(.1) do
            if _G.SwanCoat then
                pcall(function()
                    ...
                    else _tp(CFrame.new(5325.09619, 7.03906584, 719.570679, -0.309060812, 0, 0.951042235, 0, 1, 0, -0.951042235, 0, -0.309060812)) end
                end)
            end
        end
    end)
    ...
    Q:OnChanged(function(Value) _G.IceBossRen = Value end)
    spawn(function()
        pcall(function()
            while wait(.1) do
    ...
    Q:OnChanged(function(Value) _G.KeysRen = Value end)
    spawn(function()
        while wait(.1) do
            pcall(function()
                if _G.KeysRen then
    ...
    Q:OnChanged(function(Value) _G.AutoTridentW2 = Value end)
    spawn(function()
        while wait(.1) do
            pcall(function()
    ...
    Q:OnChanged(function(Value) _G.LongsWord = Value end)
    spawn(function()
        while wait(.1) do
            pcall(function()
    ...
    Q:OnChanged(function(Value) _G.BlackSpikey = Value end)
    spawn(function()
        while wait(.1) do
    ...
    Q:OnChanged(function(Value) _G.DarkBladev3 = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
                if _G.DarkBladev3 and World2 then
                    ...
                    if GetBP("Fist of Darkness") > 1 then
                        if not workspace.Enemies:FindFirstChild("Darkbeard") then _tp(CFrame.new(3677.08203125, 62.751937866211, -3144.8332519531))
                    ...
                    else _G.AutoFarmChest = true; end        
                end
            end)
        end
    end)
    ...
    Q:OnChanged(function(Value) _G.AutoEcBoss = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
                if _G.AutoEcBoss then
                    if GetM("Ectoplasm") >= 99 then replicated.Remotes.CommF_:InvokeServer("Ectoplasm","Buy", 3)
    ...
    Q:OnChanged(function(Value) _G.Auto_Def_DarkCoat = Value end)
    spawn(function()
        while wait(.1) do
            if _G.Auto_Def_DarkCoat then
                pcall(function()
                    if GetBP("Fist of Darkness") and not workspace.Enemies:FindFirstChild("Darkbeard") then _tp(CFrame.new(3677.08203125, 62.751937866211, -3144.8332519531))
                            ...
                            for _,y in pairs(FruitPrice) do
                                for _,z in pairs(FruitStore) do
                                    if y == z and replicated.Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess == nil then
                                        _G.StoreF = false
                                        if not plr.Backpack:FindFirstChild(FruitStore) then replicated.Remotes.CommF_:InvokeServer("LoadFruit",tostring(y))
                                        else
    ...
    Q:OnChanged(function(Value) _G.Auto_SwanGG = Value end)
    spawn(function()
        while wait(.2) do
    ...
    Q:OnChanged(function(Value) _G.AutoBigmom = Value end)
    spawn(function()
        while wait(Sec) do
            if _G.AutoBigmom then
                pcall(function()
                    ...
                    else _tp(CFrame.new(-709.3132934570312, 381.6005859375, -11011.396484375)) end
                end)
            end
        end
    end)

    -- [Auto Canvendish Sword]
    local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Canvendish Sword", Description = "", Default = false})
    Q:OnChanged(function(Value) _G.Auto_Cavender = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
                if _G.Auto_Cavender then
                    ...
                    else _tp(CFrame.new(5283.609375,22.56223487854,-110.78285217285)) end
                end
            end)
        end
    end)
    ...
    Q:OnChanged(function(Value) _G.TwinHook = Value end)
    spawn(function()
        while wait(Sec) do
            pcall(function()
                if _G.TwinHook then
    ...
    Q:OnChanged(function(Value) _G.AutoSerpentBow = Value end)
    spawn(function()
        while wait(Sec) do
            if _G.AutoSerpentBow then
                ...
                else _tp(CFrame.new(5821.89794921875, 1019.0950927734375, -73.71923065185547)) end
            end
        end
    end)
    ...
    Q:OnChanged(function(Value) _G.AutoKilo = Value end)
    spawn(function()
        while wait(.2) do
            if _G.AutoKilo then
                pcall(function()
                    ...
                    else _tp(CFrame.new(2764.2233886719, 432.46154785156, -7144.4580078125)) end
                end)
            end
        end
    end)
    ...
    -- ============================================================
    -- ABA MAGNETIC EVENT (SUBSTITUI A ABA VALENTINE)
    -- ============================================================
    local AutoMagneticEvent = Tabs.Magnetic:AddToggle("AutoMagneticEvent", {
        Title = "⚡ Auto Farm Magnetic Event",
        Description = "Farmar inimigos magnéticos automaticamente",
        Default = false
    })
    AutoMagneticEvent:OnChanged(function(Value)
        _G.AutoMagneticEvent = Value
    end)

    local AutoCollectTokens = Tabs.Magnetic:AddToggle("AutoCollectTokens", {
        Title = "🧲 Auto Collect Magnetic Tokens",
        Description = "Coletar tokens magnéticos do chão",
        Default = false
    })
    AutoCollectTokens:OnChanged(function(Value)
        _G.AutoCollectTokens = Value
    end)

    Tabs.Magnetic:AddButton({
        Title = "🎰 Roll Magnetic Gacha (500 tokens)",
        Description = "Gira o gacha magnético em Zioles (Middle Town)",
        Callback = function()
            print("[Dragon Hub] Rolando Magnetic Gacha...")
            for _, npc in pairs(replicated.NPCs:GetChildren()) do
                if npc.Name == "Zioles" then
                    _tp(npc.HumanoidRootPart.CFrame)
                    wait(1)
                    replicated.Remotes.CommF_:InvokeServer("MagneticGacha", 500)
                    return
                end
            end
            warn("Zioles não encontrado.")
        end
    })

    local AutoRollGacha = Tabs.Magnetic:AddToggle("AutoRollGacha", {
        Title = "🔄 Auto Roll Gacha",
        Description = "Rolar automaticamente quando tiver 500 tokens",
        Default = false
    })
    AutoRollGacha:OnChanged(function(Value)
        _G.AutoRollGacha = Value
    end)

    Tabs.Magnetic:AddButton({
        Title = "📍 Teleport to Zioles (Middle Town)",
        Description = "Ir direto ao NPC do gacha",
        Callback = function()
            for _, npc in pairs(replicated.NPCs:GetChildren()) do
                if npc.Name == "Zioles" then
                    _tp(npc.HumanoidRootPart.CFrame)
    ...
    Tabs.Magnetic:AddParagraph({
        Title = "📋 Sobre o Magnetic Event",
        Content = "O evento magnético ocorre no início de cada hora (XX:00).\n" ..
                  "⏱ Duração: 10 minutos.\n" ..
                  "👾 Inimigos com aura azul dropam tokens.\n" ..
                  "🎯 Cada inimigo dropa ~22-25 Magnetic Tokens.\n" ..
                  "🎰 500 tokens = 1 rolagem no Magnetic Gacha.\n" ..
                  "🎁 Recompensas incluem frutas raras, acessórios e skins."
    })

    local TokenStatus = Tabs.Magnetic:AddParagraph({
        Title = "🪙 Tokens Atuais",
        Content = "Carregando..."
    })
    spawn(function()
        while wait(2) do
            pcall(function()
                local tokens = GetM("MagneticToken") or 0
                TokenStatus:SetDesc("🪙 Tokens: " .. tokens .. " / 500")
            end)
        end
    end)

    -- Loops de execução do Magnetic Event
    spawn(function()
        while wait(0.5) do
            if _G.AutoMagneticEvent then
                pcall(function()
                    for _, enemy in pairs(Enemies:GetChildren()) do
                        if enemy:FindFirstChild("Humanoid") and enemy.Humanoid.Health > 0 then
                            if string.find(enemy.Name, "Magnetic") or enemy:FindFirstChild("MagneticAura") then
                                Attack.Kill(enemy, _G.AutoMagneticEvent)
                            end
                        end
                    end
                end)
    ...
    spawn(function()
        while wait(0.3) do
            if _G.AutoCollectTokens then
                pcall(function()
                    for _, obj in pairs(workspace:GetChildren()) do
                        if obj:IsA("Part") and string.find(obj.Name, "MagnetToken") then
                            _tp(obj.CFrame)
                            wait(0.1)
                        end
                    end
    ...
    -- ============================================================
    -- SEA EVENT TAB (mantido intacto – apenas um resumo)
    -- ============================================================
    -- [Todas as funções de Sea Event foram mantidas intactas]
    -- [Auto Shark, Piranha, Terror Shark, Fish Crew, Haunted Crew, Sea Beast, Leviathan]
    -- [Auto Sail Boat, Kitsune Island, etc.]

    -- ============================================================
    -- MIRAGE TAB (mantido intacto)
    -- ============================================================
    -- [Auto Find Mirage, Collect Gear, Skull Guitar, Auto Train V4, etc.]

    -- ============================================================
    -- DRAGO TAB (mantido intacto)
    -- ============================================================
    -- [Dojo Trainer, Dragon Hunter, Drago V1/V2/V3, Relic Trial, etc.]

    -- ============================================================
    -- PREHISTORIC TAB (mantido intacto)
    -- ============================================================
    -- [Auto Find Prehistoric, Craft Volcanic Magnet, Patch Volcano, etc.]

    -- ============================================================
    -- RAIDS TAB (mantido intacto)
    -- ============================================================
    -- [Auto Start Raid, Auto Complete Raid, Auto Awakening, Kill Aura, etc.]

    -- ============================================================
    -- COMBAT TAB (mantido intacto)
    -- ============================================================
    -- [Aimbot, Teleport to Players, ESP, etc.]

    -- ============================================================
    -- TRAVEL TAB (mantido intacto)
    -- ============================================================
    -- [Travel Worlds, Islands, Portals, NPCs]

    -- ============================================================
    -- FRUIT TAB (mantido intacto)
    -- ============================================================
    -- [Buy Fruits, Auto Random Fruit, Auto Drop/Store, Tween to Fruit]

    -- ============================================================
    -- SHOP TAB (mantido intacto)
    -- ============================================================
    -- [Buy Buso, Geppo, Soru, Ken, Fighting Styles, Accessories, Weapons]

    -- ============================================================
    -- MISC TAB (mantido intacto)
    -- ============================================================
    -- [Rejoin/Hop Server, Disable Chat/Leaderboard, Set Team, Unlock Portals, RTX Mode, Low CPU, Full Bright]
    ...
    print("🧲 Evento Magnético ativado na aba 'Magnetic Event'")
    print("👤 By: Norton")
    print("✨ Efeito acrílico ativado!")
end) -- FECHA KeySystem:OnKeyValidation