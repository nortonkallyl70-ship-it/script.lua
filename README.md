...
task.spawn(function()
    ...
    local telaKey = Instance.new("ScreenGui")
    telaKey.Name = "MysticKey"
    telaKey.ResetOnSpawn = false
    telaKey.IgnoreGuiInset = true
    telaKey.Parent = plr:WaitForChild("PlayerGui")

    local fundoK = Instance.new("Frame")
    fundoK.Size = UDim2.new(1, 0, 1, 0)
    fundoK.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    fundoK.BackgroundTransparency = 0.35
    fundoK.BorderSizePixel = 0
    fundoK.Parent = telaKey

    local janelaK = Instance.new("Frame")
    janelaK.Size = UDim2.new(0, 420, 0, 280)
    janelaK.Position = UDim2.new(0.5, -210, 0.5, -140)
    janelaK.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
    janelaK.BorderSizePixel = 0
    janelaK.Active = true
    janelaK.Draggable = true
    janelaK.Parent = fundoK
    Instance.new("UICorner", janelaK).CornerRadius = UDim.new(0, 12)

    local bordaK = Instance.new("UIStroke", janelaK)
    bordaK.Color = Color3.fromRGB(140, 60, 255)
    bordaK.Thickness = 2
    bordaK.Transparency = 0.3

    local topoK = Instance.new("Frame")
    topoK.Size = UDim2.new(1, 0, 0, 50)
    topoK.BackgroundColor3 = Color3.fromRGB(140, 60, 255)
    topoK.BorderSizePixel = 0
    topoK.Parent = janelaK
    Instance.new("UICorner", topoK).CornerRadius = UDim.new(0, 12)

    local topoKFix = Instance.new("Frame")
    topoKFix.Size = UDim2.new(1, 0, 0, 20)
    topoKFix.Position = UDim2.new(0, 0, 1, -20)
    topoKFix.BackgroundColor3 = Color3.fromRGB(140, 60, 255)
    topoKFix.BorderSizePixel = 0
    topoKFix.Parent = topoK

    local iconeK = Instance.new("TextLabel")
    iconeK.Size = UDim2.new(0, 36, 0, 36)
    iconeK.Position = UDim2.new(0, 10, 0, 7)
    iconeK.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    iconeK.BackgroundTransparency = 0.85
    iconeK.Text = "🌩"
    iconeK.TextColor3 = Color3.fromRGB(255, 255, 255)
    iconeK.Font = Enum.Font.GothamBold
    iconeK.TextSize = 18
    iconeK.BorderSizePixel = 0
    iconeK.Parent = topoK
    Instance.new("UICorner", iconeK).CornerRadius = UDim.new(0, 8)

    local tituloK = Instance.new("TextLabel")
    tituloK.Size = UDim2.new(1, -60, 0, 20)
    tituloK.Position = UDim2.new(0, 55, 0, 8)
    tituloK.BackgroundTransparency = 1
    tituloK.Text = "🌩 Mystic Hub 🌩"
    tituloK.TextColor3 = Color3.fromRGB(255, 255, 255)
    tituloK.Font = Enum.Font.GothamBold
    tituloK.TextSize = 15
    tituloK.TextXAlignment = Enum.TextXAlignment.Left
    tituloK.Parent = topoK

    local subK = Instance.new("TextLabel")
    subK.Size = UDim2.new(1, -60, 0, 15)
    subK.Position = UDim2.new(0, 55, 0, 27)
    subK.BackgroundTransparency = 1
    subK.Text = "Sistema de Key | Premium"
    subK.TextColor3 = Color3.fromRGB(220, 210, 255)
    subK.Font = Enum.Font.Gotham
    subK.TextSize = 10
    subK.TextXAlignment = Enum.TextXAlignment.Left
    subK.Parent = topoK

    local instrucao = Instance.new("TextLabel")
    instrucao.Size = UDim2.new(1, -40, 0, 50)
    instrucao.Position = UDim2.new(0, 20, 0, 65)
    instrucao.BackgroundTransparency = 1
    instrucao.Text = "Cole sua key abaixo para liberar o Mystic Hub\nPegue a key no Discord: discord.gg/7YFHXWnb"
    instrucao.TextColor3 = Color3.fromRGB(200, 200, 210)
    instrucao.Font = Enum.Font.Gotham
    instrucao.TextSize = 11
    instrucao.TextWrapped = true
    instrucao.Parent = janelaK

    local caixaKey = Instance.new("TextBox")
    caixaKey.Size = UDim2.new(1, -40, 0, 36)
    caixaKey.Position = UDim2.new(0, 20, 0, 125)
    caixaKey.BackgroundColor3 = Color3.fromRGB(35, 35, 45)
    caixaKey.BorderSizePixel = 0
    caixaKey.Text = ""
    caixaKey.PlaceholderText = "Cole sua key aqui..."
    caixaKey.PlaceholderColor3 = Color3.fromRGB(140, 140, 160)
    caixaKey.TextColor3 = Color3.fromRGB(230, 230, 240)
    caixaKey.Font = Enum.Font.Gotham
    caixaKey.TextSize = 12
    caixaKey.ClearTextOnFocus = false
    caixaKey.Parent = janelaK
    Instance.new("UICorner", caixaKey).CornerRadius = UDim.new(0, 6)

    local botaoPegar = Instance.new("TextButton")
    botaoPegar.Size = UDim2.new(0.48, -22, 0, 36)
    botaoPegar.Position = UDim2.new(0, 20, 0, 175)
    botaoPegar.BackgroundColor3 = Color3.fromRGB(35, 35, 45)
    botaoPegar.Text = "🔗 Pegar Key"
    botaoPegar.TextColor3 = Color3.fromRGB(230, 230, 240)
    botaoPegar.Font = Enum.Font.GothamBold
    botaoPegar.TextSize = 12
    botaoPegar.BorderSizePixel = 0
    botaoPegar.Parent = janelaK
    Instance.new("UICorner", botaoPegar).CornerRadius = UDim.new(0, 6)

    botaoPegar.MouseButton1Click:Connect(function()
        pcall(function() setclipboard("https://discord.gg/7YFHXWnb") end)
        botaoPegar.Text = "✅ Copiado!"
        task.wait(2)
        botaoPegar.Text = "🔗 Pegar Key"
    end)

    local botaoValidar = Instance.new("TextButton")
    botaoValidar.Size = UDim2.new(0.48, -22, 0, 36)
    botaoValidar.Position = UDim2.new(0.52, 2, 0, 175)
    botaoValidar.BackgroundColor3 = Color3.fromRGB(140, 60, 255)
    botaoValidar.Text = "✓ Validar Key"
    botaoValidar.TextColor3 = Color3.fromRGB(255, 255, 255)
    botaoValidar.Font = Enum.Font.GothamBold
    botaoValidar.TextSize = 12
    botaoValidar.BorderSizePixel = 0
    botaoValidar.Parent = janelaK
    Instance.new("UICorner", botaoValidar).CornerRadius = UDim.new(0, 6)

    local statusLbl = Instance.new("TextLabel")
    statusLbl.Size = UDim2.new(1, -40, 0, 20)
    statusLbl.Position = UDim2.new(0, 20, 0, 220)
    statusLbl.BackgroundTransparency = 1
    statusLbl.Text = ""
    statusLbl.TextColor3 = Color3.fromRGB(140, 140, 160)
    statusLbl.Font = Enum.Font.Gotham
    statusLbl.TextSize = 11
    statusLbl.Parent = janelaK

    _G._KeyEsperando = true

    botaoValidar.MouseButton1Click:Connect(function()
        local key = caixaKey.Text
        if key == "" then
            statusLbl.Text = "❌ Cole uma key antes de validar"
            statusLbl.TextColor3 = Color3.fromRGB(255, 100, 100)
            return
        end
        statusLbl.Text = "⏳ Validando..."
        statusLbl.TextColor3 = Color3.fromRGB(255, 200, 100)
        task.wait(1)
        if KEY_VALIDA == "" or key == KEY_VALIDA then
            statusLbl.Text = "✅ Key válida! Carregando hub..."
            statusLbl.TextColor3 = Color3.fromRGB(100, 255, 100)
            task.wait(1)
            telaKey:Destroy()
            _G._KeyEsperando = false
        else
...
-- ✅ CORREÇÃO APLICADA AQUI: bloqueio real (sem task.spawn)
repeat task.wait(0.1) until game:IsLoaded()
repeat task.wait(0.1) until _G._KeyEsperando ~= nil
repeat task.wait(0.1) until _G._KeyEsperando == false

-- ═══════════════════════════════════════════════════════════
-- CAVEIRAHUB ORIGINAL (nada alterado)
-- ═══════════════════════════════════════════════════════════
task.spawn(function()
    repeat task.wait() until game:IsLoaded() and game.Players.LocalPlayer
    task.wait(1)
...
endgame.StarterGui:SetCore("SendNotification", {
    Title = "Teste",
    Text = "Se você viu isso, funcionou!",
    Duration = 10
...
endUseskills = function(weapon, skill)
...
endlocal block = Instance.new("Part", workspace)
...
endlocal Fluent = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))()
local Window = Fluent:CreateWindow({Title = "👾MysticHub👾",SubTitle = "| By:Mystic",TabWidth = 180,Size = UDim2.fromOffset(660, 440),Acrylic = true,Theme = "Amethyst",MinimizeKey = Enum.KeyCode.End})
...
end)Tabs.Main:AddSection("Miscellanea / Quest")
...
end)local Bartilo = Tabs.Main:AddToggle("Bartilo", {Title = "Auto Done Bartilo Quest", Description = "", Default = false})
...
end)Tabs.Main:AddSection("Generals Quests / Items")
